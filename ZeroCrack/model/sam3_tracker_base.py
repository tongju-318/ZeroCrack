...
from zerocrack.model.memory import SimpleMaskEncoder

from zerocrack.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames

from zerocrack.sam.mask_decoder import MaskDecoder, MLP
from zerocrack.sam.prompt_encoder import PromptEncoder
from zerocrack.sam.transformer import TwoWayTransformer
from zerocrack.train.data.collator import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _compile_all_components(self):
        ...
        from zerocrack.perflib.compile import compile_wrapper
